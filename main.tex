...
\begin{document}
  \begin{multicols}{2}
    ...
    %
    % 4.6 Triangularisation, Diagonalisation and the Cayley-Hamiltonian theorem
    ...
    %
    % 6.1 Motivation
    %\input{src/ch6/s1.tex}  % purely prose
    %
    % 6.2 Statement and Strategy of Proof
    \input{src/ch6/s2.tex}
    %
    % 6.3 OK, let's go! The proof of JNF
    \input{src/ch5/s3.tex}
    % 6.4 Purely prose
    % 6.5 pagerank (non-examinable)
  \end{multicols}
\end{document}
